...
The search script is vendored into this repository at `.claude/skills/ui-ux-pro-max/scripts/search.py`. Always invoke it by that path from the project root — do not assume any other working directory:
